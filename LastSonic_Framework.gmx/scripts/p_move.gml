//controls
key_u = keyboard_check(global.Key_UP) || gamepad_button_check(0,gp_padu);
key_l = keyboard_check(global.Key_LEFT) || gamepad_button_check(0,gp_padl);
key_r = keyboard_check(global.Key_RIGHT) || gamepad_button_check(0,gp_padr);
key_d = keyboard_check(global.Key_DOWN) || gamepad_button_check(0,gp_padd);
key_a = keyboard_check_pressed(global.Key_A) || gamepad_button_check_pressed(0,gp_face1);
key_ar = keyboard_check_released(global.Key_AR) || gamepad_button_check_released(0,gp_face1);
key_b = keyboard_check_pressed(global.Key_B) || gamepad_button_check_pressed(0,gp_face2);
key_x = keyboard_check_pressed(global.Key_X) || gamepad_button_check_pressed(0,gp_face3);
key_y = keyboard_check_pressed(global.Key_Y) || gamepad_button_check_pressed(0,gp_face4);
