...
//landing
if (action != 0 || (action == 0 && (sprp == spr_Sonic_fall || sprp == spr_Shadow_jump))) && action > -1 && action != 2 && action != 16 && action != 17 && action != 8 && action != 9 && action != 22 && action != 26 && ground && collision_line(x,y,x+20*asin,y+20*acos,obj_walls,true,true)
{    
...
if action == 15
{
    if !audio_is_playing(snd_SonicQTE)
